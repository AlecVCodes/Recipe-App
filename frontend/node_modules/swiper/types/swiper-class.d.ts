...
import type { CSSSelector, SwiperModule } from 'swiper/types/shared.js';
import type { SwiperEvents } from 'swiper/types/swiper-events.js';

import type { A11yMethods } from 'swiper/types/modules/a11y.js';
import type { AutoplayMethods } from 'swiper/types/modules/autoplay.js';
import type { ControllerMethods } from 'swiper/types/modules/controller.js';
import type { CoverflowEffectMethods } from 'swiper/types/modules/effect-coverflow.js';
import type { CubeEffectMethods } from 'swiper/types/modules/effect-cube.js';
import type { FadeEffectMethods } from 'swiper/types/modules/effect-fade.js';
import type { FlipEffectMethods } from 'swiper/types/modules/effect-flip.js';
import type { CreativeEffectMethods } from 'swiper/types/modules/effect-creative.js';
import type { CardsEffectMethods } from 'swiper/types/modules/effect-cards.js';
import type { HashNavigationMethods } from 'swiper/types/modules/hash-navigation.js';
import type { HistoryMethods } from 'swiper/types/modules/history.js';
import type { KeyboardMethods } from 'swiper/types/modules/keyboard.js';
import type { MousewheelMethods } from 'swiper/types/modules/mousewheel.js';
import type { NavigationMethods } from 'swiper/types/modules/navigation.js';
import type { PaginationMethods } from 'swiper/types/modules/pagination.js';
import type { ParallaxMethods } from 'swiper/types/modules/parallax.js';
import type { ScrollbarMethods } from 'swiper/types/modules/scrollbar.js';
import type { ThumbsMethods } from 'swiper/types/modules/thumbs.js';
import type { VirtualMethods } from 'swiper/types/modules/virtual.js';
import type { ZoomMethods } from 'swiper/types/modules/zoom.js';
import type { FreeModeMethods } from 'swiper/types/modules/free-mode.js';
import type { ManipulationMethods } from 'swiper/types/modules/manipulation.js';
