import type { A11yOptions } from 'swiper/types/modules/a11y.js';
import type { AutoplayOptions } from 'swiper/types/modules/autoplay.js';
import type { ControllerOptions } from 'swiper/types/modules/controller.js';
import type { CoverflowEffectOptions } from 'swiper/types/modules/effect-coverflow.js';
import type { CubeEffectOptions } from 'swiper/types/modules/effect-cube.js';
import type { FadeEffectOptions } from 'swiper/types/modules/effect-fade.js';
import type { FlipEffectOptions } from 'swiper/types/modules/effect-flip.js';
import type { CreativeEffectOptions } from 'swiper/types/modules/effect-creative.js';
import type { CardsEffectOptions } from 'swiper/types/modules/effect-cards.js';
import type { HashNavigationOptions } from 'swiper/types/modules/hash-navigation.js';
import type { HistoryOptions } from 'swiper/types/modules/history.js';
import type { KeyboardOptions } from 'swiper/types/modules/keyboard.js';
import type { MousewheelOptions } from 'swiper/types/modules/mousewheel.js';
...
import type { ParallaxOptions } from 'swiper/types/modules/parallax.js';
import type { ScrollbarOptions } from 'swiper/types/modules/scrollbar.js';
import type { ThumbsOptions } from 'swiper/types/modules/thumbs.js';
import type { VirtualOptions } from 'swiper/types/modules/virtual.js';
import type { ZoomOptions } from 'swiper/types/modules/zoom.js';
import type { FreeModeOptions } from 'swiper/types/modules/free-mode.js';
import type { GridOptions } from 'swiper/types/modules/grid.js';
